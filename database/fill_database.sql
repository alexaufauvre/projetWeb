...
VALUES ('2017-05-22','Pastaria', 2),
       ...
       ('2017-05-24','Grill', 8),
       ('2017-05-24','Grill', 7),
       ('2017-05-26','Little Italy', 24),
       ('2017-05-26','Little Italy', 26),
       ('2017-05-26','L\'(x)tra', 21),
       ('2017-05-26','L\'(x)tra', 22),
       ('2017-05-26','L\'(x)tra', 20),
       ('2017-05-26','Entrées Chaudes', 34),
       ('2017-05-26','Pastaria', 2),
       ('2017-05-26','Pastaria', 10),
       ('2017-05-26','Saveurs de la Mer', 31),
       ('2017-05-26','Saveurs de la Mer', 32),
       ('2017-05-26','Saveurs de la Mer', 33),
       ('2017-05-26','Grill', 8),
       ('2017-05-26','Grill', 7),
       ('2017-05-26','Rôtisserie', 36),
       ('2017-05-26','Rôtisserie', 37),
       ('2017-05-26','Cuisine du Monde', 40),
       ('2017-05-26','Cuisine du Monde', 42),
       ('2017-05-26','Cuisine du Monde', 33),
       ('2017-05-26','Plats des Régions', 30);
